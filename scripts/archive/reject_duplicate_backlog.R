...
main <- function(cli_args = NULL) {
  ...
  ensure_packages(c("readr", "digest"))
  ...
  reviewer <- get_arg_value("--reviewer", "MV")
  reviewed_at <- get_arg_value("--reviewed-at", "2026-06-05")
  ...
  overrides <- read_accreditation_editorial_overrides(input_path)
