...
# This script builds the canonical raw IPEDS tracker dataset by downloading
# annual source tables, resolving the variables we care about, and writing one
# wide institution-year dataframe for downstream joins.
