...
#
# Pure helper functions for the IPEDS data pipeline.
# Source this after utils.R inside main() in build_ipeds_canonical_dataset.R
# and any other script that needs these utilities.
#
# Requires: dplyr, purrr, readxl (loaded by the caller)
# Requires: to_num, safe_pct_change, %||% from utils.R
...
# ---------------------------------------------------------------------------
# Per-institution enrichment helpers
# (called by enrich_group; each takes (df, years, lookups) and returns df)
# ---------------------------------------------------------------------------
