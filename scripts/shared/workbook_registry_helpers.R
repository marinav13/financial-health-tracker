...
build_article_workbook_registry <- function(
  ...
  article_points = data.frame(stringsAsFactors = FALSE),
  article_graphics = data.frame(stringsAsFactors = FALSE),
  bacc_benchmarks,
  all_sheet_bacc,
  base_sheets,
  state_breakdown,
  ...
  list(
    ...
    ArticlePoints = article_points,
    ArticleGraphics = article_graphics,
